...
type
  TfrmMain = class(TForm)
    ...
    procedure ConsoleIO_Error(Sender: TObject; const Cmd: AnsiString);
    procedure ConsoleIO_ProcessStatusChange(Sender: TObject; IsRunning: Boolean);
    procedure ConsoleIO_ReceiveError(Sender: TObject; const Cmd: AnsiString);
    procedure ConsoleIO_ReceiveOutput(Sender: TObject; const Cmd: AnsiString);
...
procedure TfrmMain.ConsoleIO_Error(Sender: TObject; const Cmd: AnsiString);
begin
